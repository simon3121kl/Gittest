...
extern const MIDL_SERVER_INFO IFistClass_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFistClass_ProxyInfo;
...
/* Object interface: IFistClass, ver. 0.0,
   GUID={0xE80C4272,0x2CDF,0x49DD,{0x94,0x8F,0xE4,0xD0,0x5F,0xC1,0x6D,0x3D}} */

#pragma code_seg(".orpc")
static const unsigned short IFistClass_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IFistClass_ProxyInfo =
    {
    &Object_StubDesc,
    AtlTest__MIDL_ProcFormatString.Format,
    &IFistClass_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFistClass_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    AtlTest__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IFistClassProxyVtbl = 
{
    &IFistClass_ProxyInfo,
    &IID_IFistClass,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IFistClass::Add */
};


static const PRPC_STUB_FUNCTION IFistClass_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IFistClassStubVtbl =
{
    &IID_IFistClass,
    &IFistClass_ServerInfo,
    8,
    &IFistClass_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
{
    ( CInterfaceProxyVtbl *) &_IFistClassProxyVtbl,
...
int __stdcall _AtlTest_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _AtlTest, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _AtlTest, 2, *pIndex )
